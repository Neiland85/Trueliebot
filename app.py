...
def analyze_conversation(conversation):
    ...
    try:
        ...
        if conversation_length > 0:
            ...
            #sentiment = analyze_sentiment(response.choices[0].text) #analyze_sentiment es una función redundante en la funcion analyze_conversation que realiza lo mismo con OpenAI haciendo dos peticiones a la API con coste, y para abaratar costes realizamos la función completa con la variable sentiment en una sola petición a la API dentro de analyze_conversation
